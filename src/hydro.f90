...
SUBROUTINE hydro
    ...
    !$omp map(to:chunk%tiles(1)%field%pressure)   &
    !$omp map(to:chunk%tiles(1)%field%soundspeed) &
    !$omp map(to:chunk%tiles(1)%field%viscosity)  &
    !$omp map(to:chunk%tiles(1)%field%xvel0)      &
    !$omp map(to:chunk%tiles(1)%field%yvel0)      &
    !$omp map(to:chunk%tiles(1)%field%xvel1)      &
    !$omp map(to:chunk%tiles(1)%field%yvel1)      &
    !$omp map(to:chunk%tiles(1)%field%vol_flux_x) &
    !$omp map(to:chunk%tiles(1)%field%vol_flux_y) &
    !$omp map(to:chunk%tiles(1)%field%mass_flux_x)&
    !$omp map(to:chunk%tiles(1)%field%mass_flux_y)&
    !$omp map(to:chunk%tiles(1)%field%volume)     &
    !$omp map(to:chunk%tiles(1)%field%work_array1)&
    !$omp map(to:chunk%tiles(1)%field%work_array2)&
    !$omp map(to:chunk%tiles(1)%field%work_array3)&
    !$omp map(to:chunk%tiles(1)%field%work_array4)&
    !$omp map(to:chunk%tiles(1)%field%work_array5)&
    !$omp map(to:chunk%tiles(1)%field%work_array6)&
    !$omp map(to:chunk%tiles(1)%field%work_array7)&
